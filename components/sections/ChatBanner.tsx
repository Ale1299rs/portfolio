        ...
        >
          ...
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/80 px-3 py-1 text-xs font-medium text-muted backdrop-blur">
              ...
              <InlineTranslation namespace="chatBanner" tKey="eyebrow" initialText={t("eyebrow")} />
            </div>

            <h2 className="mt-5 text-display-md font-semibold tracking-tight">
              <InlineTranslation namespace="chatBanner" tKey="title" initialText={t("title")} />
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">
              <InlineTranslation namespace="chatBanner" tKey="description" initialText={t("description")} />
            </p>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              >
                ...
                <InlineTranslation namespace="chatBanner" tKey="cta" initialText={t("cta")} />
              </button>
              <p className="text-xs text-muted">
                <InlineTranslation namespace="chatBanner" tKey="hint" initialText={t("hint")} />
              </p>
            </div>
          </div>
        </motion.div>
